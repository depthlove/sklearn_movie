...
int main(){
	...
	*/
	...
	//printf("%d\n", testdata7.size());
	short a7[64] = { 16,12,11,18,19,11,29,69,15,13,12,17,18,20,57,112,16,17,16,16,11,15,62,127,14,18,19,19,11,10,52,115,13,15,17,20,17,17,57,116,20,17,13,14,13,16,57,116,21,19,14,13,9,11,52,112,10,14,18,21,17,16,57,118 };
	short* pBlock3 = (short*)&a7;
